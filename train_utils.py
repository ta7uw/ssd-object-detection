...
class MultiboxTrainChain(chainer.Chain):
    """
    Wrapping the SSD model for using multibox_loss
    """
...
def train(train_data, val_data, label_names,
          ...
          resume):
    """
    This function is for training SSD model for object detection
    """
    # Using pretrained model to shorten training
    pretrained_model = SSD512(
        pretrained_model='voc0712')

    # Define SSD512 model.Setting number of classification
    ...
    # Transform dataset using 'Transform' class
